...
_G.packer_plugins = {
  ...
  ["cmp-copilot"] = {
    loaded = true,
    path = "/Users/dennis/.local/share/nvim/site/pack/packer/start/cmp-copilot",
  ...
  ["copilot.vim"] = {
    loaded = true,
    path = "/Users/dennis/.local/share/nvim/site/pack/packer/start/copilot.vim",
  ...
  ["nvim-comment"] = {
    loaded = true,
    path = "/Users/dennis/.local/share/nvim/site/pack/packer/start/nvim-comment",
  ...
  ["nvim-tree.lua"] = {
    loaded = true,
    path = "/Users/dennis/.local/share/nvim/site/pack/packer/start/nvim-tree.lua",
  ...
  ["popup.nvim"] = {
    loaded = true,
    path = "/Users/dennis/.local/share/nvim/site/pack/packer/start/popup.nvim",
  ...
  ["smart-pairs"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/dennis/.local/share/nvim/site/pack/packer/opt/smart-pairs",
    url = "https://github.com/ZhiyuanLck/smart-pairs"
  },
  ["telescope-media-files.nvim"] = {
    loaded = true,
    path = "/Users/dennis/.local/share/nvim/site/pack/packer/start/telescope-media-files.nvim",
